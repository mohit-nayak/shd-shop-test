        ...
        <>
            <div className="widget-area">
                ...
                <div className="sidebar-widget widget-category-2 mb-50">
                    ...
                    <ul>
                        <li>
                            <Link href="/shop"> <img src="/assets/imgs/theme/icons/category-1.svg" alt="" />Milks & Dairies</Link><span className="count">30</span>
                        </li>
                        <li>
                            <Link href="/shop"><img src="/assets/imgs/theme/icons/category-2.svg" alt="" />Clothing</Link><span className="count">35</span>
                        </li>
                        <li>
                            <Link href="/shop"> <img src="/assets/imgs/theme/icons/category-3.svg" alt="" />Pet Foods </Link><span className="count">42</span>
                        </li>
                        <li>
                            <Link href="/shop"><img src="/assets/imgs/theme/icons/category-4.svg" alt="" />Baking material</Link><span className="count">68</span>
                        </li>
                        <li>
                            <Link href="/shop"> <img src="/assets/imgs/theme/icons/category-5.svg" alt="" />Fresh Fruit</Link><span className="count">87</span>
                        </li>
                    </ul>
                </div>
                ...
                <div className="sidebar-widget product-sidebar mb-50 p-30 bg-grey border-radius-10">
                    ...
                    <div className="single-post clearfix">
                        ...
                        <div className="content pt-10">
                            <h6><Link href="/shop">Lorem, ipsum</Link></h6>
                            <p className="price mb-0 mt-5">$25</p>
                            <div className="product-rate">
                                <div className="product-rating" style={{ "width": "60%" }}></div>
                            </div>
